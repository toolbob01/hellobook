            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-150" align="center">
                        <div class="border border-2 rounded-2 shadow-lg my-5" style="width: 600px; height: 700px;">
                            ...
                            <div class="feed-box">
                                ...
                                <div class="feed-img border-bottom">
                                    <div id="post1" class="carousel slide" data-bs-ride="true">
                                        <div class="carousel-indicators">
                                          <button type="button" data-bs-target="#post1" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                          <button type="button" data-bs-target="#post1" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                          <button type="button" data-bs-target="#post1" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                        </div>
                                        <div class="carousel-inner">
                                          ...
                                          <div class="carousel-item">
                                            <img id="feed-img" src="https://static-storychat.pstatic.net/2020/9/1/47/208797_hm2fj34m3df60.jpg">
                                          </div>
                                          <div class="carousel-item">
                                            <img id="feed-img" src="img/add.PNG" alt="">
                                          </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#post1" data-bs-slide="prev">
                                          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                          <span class="visually-hidden">Previous</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#post1" data-bs-slide="next">
                                ...
                                <div class="icon my-3">
                                    <div>
                                        <span class="material-icons-outlined">하트 13|</span>
                                        <span class="material-icons-outlined">전체댓글|</span>
                                        <span class="material-icons-outlined">공유하기|</span>
                                    </div>
                                    <div>
                                ...
                                <div class="comment">
                                    <div> <b>기타유저1</b> 1줄 이상 ... 처리 필요 </div>
                                    <div> <b>기타유저2</b> 1줄 이상 ... 처리 필요 </div>
                                    <div> <b>기타유저3</b> 3명 정도까지만 뽑기 </div>
                                </div>
